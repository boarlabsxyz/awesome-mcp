// Source of truth: which Google Slides MCP tools are read-only vs write/mutating.
//
// Generated from src/google-slides/server.ts: every `addTool` call's `name:` appears
